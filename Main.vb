...
Public Sub paintCases(boolPlayerOne As Boolean)
    ...
    For Each value In piecesEater
        posPiece = getPosPlayer(CStr(value), isCheckP2)
...
Public Function paintLastMovementCases()
